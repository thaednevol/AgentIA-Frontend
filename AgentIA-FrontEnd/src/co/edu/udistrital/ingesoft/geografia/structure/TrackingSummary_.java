...
* @param recent
*/
public TrackingSummary_(Integer total, Integer recent) {
this.total = total;
this.recent = recent;
}
...
public TrackingSummary_ withTotal(Integer total) {
this.total = total;
return this;
}
...
public TrackingSummary_ withRecent(Integer recent) {
this.recent = recent;
return this;
}
...
public TrackingSummary_ withAdditionalProperty(String name, Object value) {
this.additionalProperties.put(name, value);
return this;
}
...
if ((other instanceof TrackingSummary_) == false) {
return false;
}
TrackingSummary_ rhs = ((TrackingSummary_) other);
